...
//                }
                ...
                [self changeCurrentView: [[UICompositeViewDescription alloc] init:@"Playboy"
                                                                          content:@"PlayboyPageController"
                                                                         stateBar:@"UIStateBar"
...
- (void)startUp {
    ...
    [self addProxyConfig:@"0600076651" password:@"12qwaszx" domain:@"203.113.125.82" server:nil];
